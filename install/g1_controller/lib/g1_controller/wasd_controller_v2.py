...
class WASDControllerV2(Node):
    ...
    def __init__(self):
        ...
        # ★ NEW: Send initial standing pose to fix ankle joint spinning issue
        self.get_logger().info('🔧 Sending initial standing pose to reset ALL joints to ZERO ANKLE values...')
        ...
        self.get_logger().info('✅ Initial pose sent! Ankle pitch and roll = 0.0')
    ...
    def get_standing_pose(self):
        ...
        for joint in self.joint_names:
            # ★★★ EVERYTHING IS ZERO - Robot will lie flat, no spinning! ★★★
            pose[joint] = 0.0
        return pose
