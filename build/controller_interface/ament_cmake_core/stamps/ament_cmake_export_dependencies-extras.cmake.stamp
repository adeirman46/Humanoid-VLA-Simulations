...
set(_exported_dependencies "hardware_interface;rclcpp_lifecycle")
...
if(NOT _exported_dependencies STREQUAL "")
  ...
  foreach(_dep ${_exported_dependencies})
    ...
    if(_libraries)
      ...
      list(APPEND _libraries ${controller_interface_LIBRARIES})
      list(REMOVE_DUPLICATES _libraries)
      set(controller_interface_LIBRARIES ${_libraries})
    endif()
  endforeach()
endif()
