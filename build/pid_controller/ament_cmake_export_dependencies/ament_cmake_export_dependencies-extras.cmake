...
set(_exported_dependencies "fmt;parameter_traits;rclcpp;rclcpp_lifecycle;rsl;tcb_span;tl_expected;angles;control_msgs;control_toolbox;controller_interface;generate_parameter_library;hardware_interface;pluginlib;rclcpp;rclcpp_lifecycle;realtime_tools;std_srvs")
...
if(NOT _exported_dependencies STREQUAL "")
  ...
  foreach(_dep ${_exported_dependencies})
    ...
    if(_libraries)
      ...
      list(APPEND _libraries ${pid_controller_LIBRARIES})
      list(REMOVE_DUPLICATES _libraries)
      set(pid_controller_LIBRARIES ${_libraries})
    endif()
  endforeach()
endif()
