...
set(_exported_dependencies "control_msgs;lifecycle_msgs;pluginlib;rclcpp_lifecycle;rcpputils;rcutils;TinyXML2;tinyxml2_vendor")
...
if(NOT _exported_dependencies STREQUAL "")
  ...
  foreach(_dep ${_exported_dependencies})
    ...
    if(_libraries)
      ...
      list(APPEND _libraries ${hardware_interface_LIBRARIES})
      list(REMOVE_DUPLICATES _libraries)
      set(hardware_interface_LIBRARIES ${_libraries})
    endif()
  endforeach()
endif()
