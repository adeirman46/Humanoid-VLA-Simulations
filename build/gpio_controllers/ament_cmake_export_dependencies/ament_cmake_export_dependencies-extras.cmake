...
set(_exported_dependencies "fmt;parameter_traits;rclcpp;rclcpp_lifecycle;rsl;tcb_span;tl_expected;controller_interface;hardware_interface;rclcpp;rclcpp_lifecycle;realtime_tools")
...
if(NOT _exported_dependencies STREQUAL "")
  ...
  foreach(_dep ${_exported_dependencies})
    ...
    if(_libraries)
      ...
      list(APPEND _libraries ${gpio_controllers_LIBRARIES})
      list(REMOVE_DUPLICATES _libraries)
      set(gpio_controllers_LIBRARIES ${_libraries})
    endif()
  endforeach()
endif()
